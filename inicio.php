...
<section class="mision-vision-valores">
    ...
    <div class="contenedor-tarjetas">
        <div class="tarjeta">
            <img src="mision2.avif" alt="Misión" class="imagen-tarjeta">
        ...
        <div class="tarjeta">
            <img src="vision.jpg" alt="Visión" class="imagen-tarjeta">
        ...
        <div class="tarjeta">
            <img src="valores.png" alt="Valores" class="imagen-tarjeta">
        ...
        <div class="tarjetas-creadores">
          ...
          <div class="tarjeta">
            <div class="imagen-container">
              <img src="ashlyfoto.jpg" alt="Creador 1">
            </div>
          ...
          <div class="tarjeta">
            <div class="imagen-container">
              <img src="vilsonfoto.jpg" alt="Creador 2">
            </div>
            <div class="contenido-tarjeta">
          ...
          <div class="tarjeta">
            <div class="imagen-container">
              <img src="ruthiefoto.jpg" alt="Creador 3">
            </div>
            <div class="contenido-tarjeta">
              <h3>Ruth Mercado</h3>
              <p>Estudiante de Desarrollo de Sofware del Instituto Politécnico Industrial Don Bosco.</p>
